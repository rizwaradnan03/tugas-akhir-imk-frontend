import { IFQuizModules } from '@/interfaces/form-interface'
import { UseEncodeFileToBase64 } from '@/lib/base64'
import { useCallback } from 'react'
import { useDropzone } from 'react-dropzone'

const QuizDropzone = ({ setFiles, files, maximumFiles, indexParent }: { setFiles: (files: IFQuizModules[]) => void, files: IFQuizModules[], maximumFiles: number, indexParent: number }) => {
